...
function AdaptationsSection({ adaptations, onSeeAll }: AdaptationsSectionProps) {
  ...
  return (
    ...
    >
      ...
      >
        {adaptations.map((c) => (
          <Card key={c.id} className="w-[240px] flex-row gap-3 p-4">
            <BookCover title={c.book} author={c.author} width={64} tone={c.bookTone} radius={12} />
