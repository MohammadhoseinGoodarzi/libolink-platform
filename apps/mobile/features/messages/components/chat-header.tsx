      ...
      <View className="h-14 flex-row items-center gap-1 px-1">
        ...
        <View className="ml-1.5 min-w-0 flex-1">
          <View className="flex-row items-center gap-1.5">
            <Text numberOfLines={1} className="shrink font-sans-bold text-[15.5px] text-foreground">
              {c.title}
            </Text>
          ...
          <Text
            ...
            className={cn(
              'text-[11.5px]',
              c.typing ? 'font-sans-medium text-primary italic' : 'font-sans text-muted-foreground',
            )}
          >
            {status}
          </Text>
