...
import { FilterChip, ModalShell, SearchInput, Text, useToast } from '@/shared/components/ui';
...
export function SearchOverlay({ open, onClose }: SearchOverlayProps) {
  ...
  return (
    <ModalShell
      ...
      panelStyle={{ paddingTop: topInset }}
      enterDuration={220}
      exitDuration={180}
    >
      <View className="border-border border-b px-3 pb-2.5">
        <View className="flex-row items-center gap-2">
          ...
          >
            <Text className="font-sans-semibold text-[15px] text-primary">{tCommon('cancel')}</Text>
          </Pressable>
        </View>
