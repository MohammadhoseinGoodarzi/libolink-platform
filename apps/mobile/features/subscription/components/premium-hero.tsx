...
import type { PremiumHeroProps } from '../types';
...
function PremiumHero({ price, compareAt }: PremiumHeroProps) {
        ...
        <View className="mt-4 flex-row items-center gap-4">
          <View>
            <View className="flex-row items-baseline gap-1">
              {compareAt != null ? (
                <Text className="font-sans-semibold text-[15px] text-white/50 line-through">
                  ${compareAt}
                </Text>
              ) : null}
              <Text
