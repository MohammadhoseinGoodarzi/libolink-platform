...
// Snappier material curve + durations than the sheet default (a drawer feels
// quicker than a modal sheet).
    ...
    >
      ...
      <View className="border-border border-t px-3 pt-2">
        ...
        >
          ...
          <Text className="font-sans-semibold text-[14.5px] text-foreground">{t('logOut')}</Text>
        </Pressable>
      </View>
    </ModalShell>
  );
